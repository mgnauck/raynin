...
@group(0) @binding(11) var<uniform> frame: Frame;
...
{
  // Sample uniform and invert directions in wrong hemisphere
...
fn renderMIS(oriPrim: vec3f, dirPrim: vec3f) -> vec3f
{
  ...
  for(var bounces=0u; bounces<(frame.bouncesSpp & 0xff); bounces++) {
