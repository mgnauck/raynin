OUTDIR=output
SRC=main.c sutil.c mutil.c printf.c log.c vec3.c cfg.c aabb.c scn.c bvh.c obj.c shape.c mat.c cam.c view.c
...
LD=wasm-ld
DBGFLAGS=-DNDEBUG
CFLAGS=--target=wasm32 -std=c2x -nostdlib -Os -ffast-math -flto -pedantic-errors -Wall -Wextra -Wno-unused-parameter -Wno-unused-variable
#CFLAGS+=-DSILENT
