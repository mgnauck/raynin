OUTDIR=output
SRC=sutil.c mutil.c printf.c log.c vec3.c mat4.c ray.c tri.c aabb.c cam.c view.c mesh.c mtl.c bvh.c tlas.c scene.c renderer.c intersect.c gltfimp.c main.c
